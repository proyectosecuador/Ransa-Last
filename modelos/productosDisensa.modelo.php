...
class ModeloProductosDisensa{
	...
	=            CONSULTAR PRODUCTOS            =
	===========================================*/
	static public function mdlConsultarProductosDisensa($tabla,$valor){

		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE 71");

		$stmt -> bindParam("71",$valor,PDO::PARAM_INT);
